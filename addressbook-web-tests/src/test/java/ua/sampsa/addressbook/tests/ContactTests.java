...
public class ContactTests extends TestBase {
  ...
  public void testNewContact() throws Exception {
    ...
    app.getContactHelper().fillNewContactForm(new ContactData("Vasya", "Olegovich", "Pupkin", "Rock-n-Roll", "Yandex", "Pobedy Street, 25", "014789564711", "pupkin@yandex.ru", "1", "January", "1987"));
